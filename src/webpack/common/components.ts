...
export const Forms = {
    ...
    /** @deprecated use Heading from 403Cord */
    FormTitle: Heading,
    /** @deprecated use Paragraph from 403Cord */
    FormText: Paragraph,
...
/** @deprecated use Paragraph, Span, or BaseText from 403Cord */
export const Text = TextCompat;
/** @deprecated use Button from 403Cord */
export const Button = ButtonCompat;
/** @deprecated Use FormSwitch from 403Cord */

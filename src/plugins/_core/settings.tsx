...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "403Cord Ayarları bölmesinin nereye koyulacağı",
        options: [
            { label: "En Tepede", value: "top" },
            { label: "Nitro ayarlarının üstünde", value: "aboveNitro", default: true },
            { label: "Nitro ayarlarının altında", value: "belowNitro" },
            { label: "Aktivite Ayarlarının üstünde", value: "aboveActivity" },
            { label: "Aktivite Ayarlarının altında", value: "belowActivity" },
            { label: "En Altta", value: "bottom" },
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const vencordEntries: SettingsLayoutNode[] = [
            ...
            !IS_UPDATER_DISABLED && UpdaterTab && buildEntry({
                key: "vencord_updater",
                title: "Güncelleyici",
                panelTitle: "403Cord Güncelleyici",
    ...
    getInfoRows() {
        ...
        const rows = [`403Cord ${additionalInfo}`];

...
export function PluginCard({ plugin, disabled, onRestartNeeded, onMouseEnter, onMouseLeave, isNew }: PluginCardProps) {
    ...
    const pTranslatedName = PluginTranslationMap[plugin.name]?.name || plugin.name;
    const pTranslatedDesc = PluginTranslationMap[plugin.name]?.description || plugin.description;

    return (
        <AddonCard
            name={pTranslatedName}
            description={pTranslatedDesc}
            isNew={isNew}
            enabled={isEnabled()}
